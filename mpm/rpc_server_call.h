...
namespace {
    ...
    struct MemFunCall<PtrObj, MemFun, R()> {
        ...
        {
            R retval = (p->*memFn)();
            return mpm::ValueTrait<R>::toValue(retval);
        }
    };
    ...
    struct MemFunCall<PtrObj, MemFun, R(P1)> {
            ...
            const ListValue &params)
        {
            ...
            params.Get(0, &p1);
            R retval = (p->*memFn)(
                mpm::ValueTrait<P1>::fromValue(*p1));
            return mpm::ValueTrait<R>::toValue(retval);
        }
    };
    ...
    struct MemFunCall<PtrObj, MemFun, R(P1, P2)> {
            ...
            const ListValue &params)
        {
            ...
            R retval = (p->*memFn)(
                mpm::ValueTrait<P1>::fromValue(*p1),
                mpm::ValueTrait<P2>::fromValue(*p2));
            return mpm::ValueTrait<R>::toValue(retval);
        }
    };
    ...
    struct MemFunCall<PtrObj, MemFun, R(P1, P2, P3)> {
            ...
            const ListValue &params)
        {
            ...
            R retval = (p->*memFn)(
                mpm::ValueTrait<P1>::fromValue(*p1),
                mpm::ValueTrait<P2>::fromValue(*p2),
                mpm::ValueTrait<P3>::fromValue(*p3));
            return mpm::ValueTrait<R>::toValue(retval);
        }
    };
    ...
    struct MemFunCall<PtrObj, MemFun, R(P1, P2, P3, P4)> {
            ...
            const ListValue &params)
        {
            ...
            R retval = (p->*memFn)(
                ...
                mpm::ValueTrait<P2>::fromValue(*p2),
                mpm::ValueTrait<P3>::fromValue(*p3),
                mpm::ValueTrait<P4>::fromValue(*p4));
            return mpm::ValueTrait<R>::toValue(retval);
        }
    };
    ...
    struct MemFunCall<PtrObj, MemFun, R(P1, P2, P3, P4, P5)> {
            ...
            const ListValue &params)
        {
            ...
            R retval = (p->*memFn)(
                ...
                mpm::ValueTrait<P3>::fromValue(*p3),
                mpm::ValueTrait<P4>::fromValue(*p4),
                mpm::ValueTrait<P5>::fromValue(*p5));
            return mpm::ValueTrait<R>::toValue(retval);
        }
    };
