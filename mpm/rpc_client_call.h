...
#include <mpm/type_traits.h>
#include <mpm/value_traits.h>
    ...
    struct ClientCallTrait {
        static R invoke(Client *c, IPC::Message *m) {
            ...
            if (!msg.get()) {
                ...
                R retval = mpm::ValueTrait<R>::fromValue(*value);
                return retval;
            }
            void *iter = 0;
            ListValue result;
            ...
            Value *value;
            result.Get(0, &value);
            return mpm::ValueTrait<R>::fromValue(*value);
        }
    };
...
public:
    ClientCall(const std::string& fn) : ClientCallBase(fn) {}
    R operator()(Client *c, typename mpm::TypeTrait<P1>::take p1)
    {
        ListValue params;
        IPC::Message *msg = newMessage();
        params.Append(mpm::ValueTrait<P1>::toValue(p1));
...
public:
    ClientCall(const std::string& fn) : ClientCallBase(fn) {}
    R operator()(Client *c, typename mpm::TypeTrait<P1>::take p1,
        typename mpm::TypeTrait<P2>::take p2)
    {
        ListValue params;
        IPC::Message *msg = newMessage();
        params.Append(mpm::ValueTrait<P1>::toValue(p1));
        params.Append(mpm::ValueTrait<P2>::toValue(p2));
        WriteParam(msg, params);
        return ClientCallTrait<R>::invoke(c, msg);
    }
};
...
public:
    ClientCall(const std::string& fn) : ClientCallBase(fn) {}
    R operator()(Client *c, typename mpm::TypeTrait<P1>::take p1,
        typename mpm::TypeTrait<P2>::take p2, typename mpm::TypeTrait<P3>::take p3)
    {
        ListValue params;
        IPC::Message *msg = newMessage();
        params.Append(mpm::ValueTrait<P1>::toValue(p1));
        params.Append(mpm::ValueTrait<P2>::toValue(p2));
        params.Append(mpm::ValueTrait<P3>::toValue(p3));
        WriteParam(msg, params);
        return ClientCallTrait<R>::invoke(c, msg);
    }
};
...
public:
    ...
    R operator()(Client *c, typename mpm::TypeTrait<P1>::take p1,
        typename mpm::TypeTrait<P2>::take p2, typename mpm::TypeTrait<P3>::take p3,
        typename mpm::TypeTrait<P4>::take p4)
    {
        ListValue params;
        IPC::Message *msg = newMessage();
        params.Append(mpm::ValueTrait<P1>::toValue(p1));
        params.Append(mpm::ValueTrait<P2>::toValue(p2));
        params.Append(mpm::ValueTrait<P3>::toValue(p3));
        params.Append(mpm::ValueTrait<P4>::toValue(p4));
        WriteParam(msg, params);
        return ClientCallTrait<R>::invoke(c, msg);
    }
};
...
public:
    ...
    R operator()(Client *c, typename mpm::TypeTrait<P1>::take p1,
        typename mpm::TypeTrait<P2>::take p2, typename mpm::TypeTrait<P3>::take p3,
        typename mpm::TypeTrait<P4>::take p4, typename mpm::TypeTrait<P5>::take p5)
    {
        ListValue params;
        IPC::Message *msg = newMessage();
        params.Append(mpm::ValueTrait<P1>::toValue(p1));
        ...
        params.Append(mpm::ValueTrait<P3>::toValue(p3));
        params.Append(mpm::ValueTrait<P4>::toValue(p4));
        params.Append(mpm::ValueTrait<P5>::toValue(p5));
        WriteParam(msg, params);
        return ClientCallTrait<R>::invoke(c, msg);
    }
};
